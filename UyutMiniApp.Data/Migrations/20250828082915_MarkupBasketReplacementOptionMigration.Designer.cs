...
namespace UyutMiniApp.Data.Migrations
{
    ...
    [Migration("20250828082915_MarkupBasketReplacementOptionMigration")]
    partial class MarkupBasketReplacementOptionMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UyutMiniApp.Domain.Entities.BasketReplacementSelection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("MenuItemBasketId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MenuItemBasketId");

                    b.HasIndex("OriginalSetItemId");

                    b.HasIndex("ReplacementMenuItemId");

                    b.ToTable("BasketReplacementSelections");
                });

            modelBuilder.Entity("UyutMiniApp.Domain.Entities.BasketToping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UyutMiniApp.Domain.Entities.FixedRecomendation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UyutMiniApp.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.Property<bool>("HasSetVerion")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasTopings")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("UyutMiniApp.Domain.Entities.OrderItemToping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UyutMiniApp.Domain.Entities.Toping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UyutMiniApp.Domain.Entities.BasketReplacementSelection", b =>
                {
                    b.HasOne("UyutMiniApp.Domain.Entities.MenuItemBasket", "MenuItemBasket")
                        .WithMany("ReplacementSelection")
                        .HasForeignKey("MenuItemBasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UyutMiniApp.Domain.Entities.BasketToping", b =>
                {
                    ...
                    b.HasOne("UyutMiniApp.Domain.Entities.Toping", "Toping")
                        .WithMany()
            ...
            modelBuilder.Entity("UyutMiniApp.Domain.Entities.OrderItemToping", b =>
                {
                    ...
                    b.HasOne("UyutMiniApp.Domain.Entities.Order", null)
                        .WithMany("SelectedTopings")
                        .HasForeignKey("OrderId");
            ...
            modelBuilder.Entity("UyutMiniApp.Domain.Entities.MenuItem", b =>
                {
                    ...
                    b.Navigation("Topings");
                });

            modelBuilder.Entity("UyutMiniApp.Domain.Entities.MenuItemBasket", b =>
                {
                    b.Navigation("ReplacementSelection");
